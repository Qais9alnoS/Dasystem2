...
export const ConstraintManager: React.FC<ConstraintManagerProps> = ({ data, onContinue }) => {
  ...
  const [constraintType, setConstraintType] = useState<'no_consecutive' | 'before_after'>('no_consecutive');
  ...
  const handleAddConstraint = () => {
    ...
    const refSubject = referenceSubject ? subjects.find(s => s.id === referenceSubject) : null;
    ...
    <div className="space-y-6" dir="rtl">
      ...
      <Alert className="bg-blue-50 border-blue-200">
        ...
        <AlertDescription className="text-blue-800">
          القيود هي شروط اختيارية تساعد في تحسين جودة الجدول. يمكنك تخطي هذه الخطوة إذا لم تكن بحاجة لقيود محددة.
        </AlertDescription>
      </Alert>
                ...
                <div className="space-y-4 py-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setConstraintType(value as 'no_consecutive' | 'before_after')}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  {constraintType === 'before_after' && (
                    <>
                      <div className="space-y-2">
                        ...
                        <Select
                          value={placement}
                          onValueChange={(value) => setPlacement(value as 'before' | 'after')}
                        >
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value) => setReferenceSubject(parseInt(value))}
                        >
                          <SelectTrigger>
                            <SelectValue placeholder="اختر المادة" />
                          </SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setPriorityLevel(parseInt(value))}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
        ...
        <CardContent>
          {constraints.length === 0 ? (
            <div className="text-center py-8 text-muted-foreground">
              ...
              <p className="text-sm">يمكنك إضافة قيود لتحسين الجدول أو المتابعة بدون قيود</p>
            </div>
          ) : (
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 space-y-2">
                      <div className="flex items-center gap-2 flex-wrap">
                        <Badge variant="outline">{getConstraintTypeLabel(constraint.constraint_type)}</Badge>
                        {getPriorityBadge(constraint.priority_level)}
                        <span className="text-sm font-medium">{constraint.subject_name}</span>
                      </div>
          ...
          <CardContent className="p-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              <div className="text-center">
                <p className="text-2xl font-bold text-blue-900">{constraints.length}</p>
